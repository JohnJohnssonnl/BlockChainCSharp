...
{
    [Serializable]
    public class SignedUpMiners
    {
        string  HardwareFingerPrint;
        string  DebitablePubAddress;

        public void SignUpLocalComputerForMining(string _DebitablePubAddress, BlockChain _chain)
        {
            HardwareFingerPrint = MakeFingerPrint();
            DebitablePubAddress = _DebitablePubAddress; //Walletpub address where reward goes to when correctly validating blocks

            _chain.AddSignedUpMiner(this);
        }
